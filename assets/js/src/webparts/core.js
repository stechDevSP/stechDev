...
function myCards() {
    $(".myCard").click(function() {
        $(".welcome-component, .profile-drop, .select-currency, .cart-icon").hide();
        var appSelectedTitle = $(this).attr("data-myApp");

        $.ajax({
            type: "GET",
            url: "http://demoexternalusers.azurewebsites.net/api/TotalCount",
            dataType: 'jsonp',
            headers: {
                "Accept": "application/json; odata=verbose"
            },
            success: function(data) {
                var blobHtml = "<div class='appST " + appSelectedTitle + "_app'><div class='goBack-selectApps'><img class='icon icons8-Long-Arrow-Left' src='data:image/png;base64,' width='26' height='26' /><div class='backLabel'>Back to my Apps</div><div class='title-myApp'>" + appSelectedTitle + "</div><div class='testCall'>" + data + "</div>";
